...
class DataProcessing():
    ...
    def format_hm_queries(self, quotes_df, quotes_col_name, hmq_col_name, authors_col_name, remove_nan):
        ...
        for quote, hm_string, author in zip(quotes_col_list, hmq_col_list, authors_col_list):
        ...
        formated_hmq_frame = pd.DataFrame({'Author': rep_author_col_list,'Quotes': rep_quotes_col_list, 'Queries': formatted_hmq_sent_list})
