...
with open('../data/split/split-conceptnet/fileCustomWords') as json_file:
    custom_words_dict = json.load(json_file)

with open('../data/split/split-hashmap/conceptnet_distribution.json') as json_file:
    conceptnet_distribution = json.load(json_file)

with open('../data/output/dictionaries/hmq_quotes_emb_dict') as json_file:
...
class GatheringEmbeddingsClass():
        ...
        for word in non_custom_words:
            ...
            if type(conceptnet_distribution[first_letter]) == dict:
                if first_letter+second_letter in conceptnet_distribution[first_letter].keys():
                    ...
                    with open('../data/split/split-conceptnet/sub-file'+file_suffix) as json_file:
                ...
                file_suffix = first_letter.upper()
                with open('../data/split/split-conceptnet/file' + file_suffix) as json_file:
                    embeddings_file = json.load(json_file)
    ...
    def sentence_embedding(self, idf_dict):
